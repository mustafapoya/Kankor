...
public class ExamSpecificViewController implements Initializable {
    ...
    class ExamForm extends Thread {
        ...
        public void run() {
            try {
                FXMLLoader fxmlLoader = new FXMLLoader(ExamSpecificViewController.class.getResource("exam-view.fxml"));
                BorderPane examView = fxmlLoader.load();
    ...
    private void loadExamResult() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(ExamSpecificViewController.class.getResource("exam-result-view.fxml"));
...
//                    result, examViewController.getDuration());
            ...
            examResultViewController.getBtnCheckQuestions().setOnAction(event -> {
                ...
                try {
                    FXMLLoader reviewLoader = new FXMLLoader(ExamSpecificViewController.class.getResource("exam-review-view.fxml"));
